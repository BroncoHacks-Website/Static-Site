      ...
      <div className="about-title-container">
        ...
        <div className="about-container">
          <div className="container-items">
              ...
              <div className="container-clubs">
                ...
                <ul>
                        ...
                        <ul>
                            ...
                            <li><a href="https://www.instagram.com/cppshecodes/" target="_blank" rel="noopener noreferrer"><img src="https://ugc.production.linktr.ee/b48bd9b5-4286-4b02-85ae-fbecf3904472_Logo--Clear.png?io=true&size=avatar-v3_0"/></a></li>
            ...
            <div className="container-hackathon-description">
              ...
              <p>
                ...
                cybersecurity. We welcome students of all skill levels to
                compete! This event is completely free to enter and food will be
                provided as well.{" "}
              </p>
